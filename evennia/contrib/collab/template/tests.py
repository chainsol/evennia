...
class TemplateTestCase(CollabTest):
    ...
    def test_unpermissioned_read(self):
        ...
        """
        self.obj1.wizdb.stuff = 'thing'
        self.assertEqual(
            evtemplate(
                "{{ fetch(this, 'wiz_stuff') }}", me=self.char2, this=self.obj1, run_as=self.char2,
            ),
            "Error when executing template. SecurityError: Char2 does not have read "
            "access to property 'wiz_stuff' on Obj"
        )
    ...
    def test_unpermissioned_write(self):
        ...
        self.assertEqual(
            evtemplate(
                "{{ store(this, 'wiz_stuff', 'things') }}", me=self.char2, this=self.obj1, run_as=self.char2,
            ),
            "Error when executing template. SecurityError: Char2 does not have write "
            "access to property 'wiz_stuff' on Obj"
        )
        self.assertIsNone(self.obj1.wizdb.stuff)
    ...
    def test_owned_no_read(self):
        ...
        self.obj1.wizhdb.stuff = 'thing'
        self.assertEqual(
            evtemplate(
                "{{ fetch(this, 'wizh_stuff') }}", me=self.char2, this=self.obj1, run_as=self.char2,
            ),
            "Error when executing template. SecurityError: Char2 does not have read "
            "access to property 'wizh_stuff' on Obj"
        )
    ...
    def test_owned_no_write(self):
        ...
        self.assertEqual(
            evtemplate(
                "{{ store(this, 'wiz_stuff', 'thing') }}", me=self.char2, this=self.obj1, run_as=self.char2,
            ),
            "Error when executing template. SecurityError: Char2 does not have write "
            "access to property 'wiz_stuff' on Obj"
        )
